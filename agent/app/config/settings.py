...
BASE_INSTRUCTIONS_ENABLED = os.getenv("AGENT_BASE_INSTRUCTIONS_ENABLED", "false").lower() == "true"
...
GREETING_THROTTLE_SECONDS = int(os.getenv("GREETING_THROTTLE_SECONDS", "90") or "90")
GREETING_DB_TTL_SECONDS = int(os.getenv("GREETING_DB_TTL_SECONDS", "86400") or "86400")
DEDUP_DB_TTL_SECONDS = int(os.getenv("DEDUP_DB_TTL_SECONDS", "21600") or "21600")
OUTBOUND_ECHO_TTL_SECONDS = int(os.getenv("OUTBOUND_ECHO_TTL_SECONDS", "900") or "900")
AI_AUTO_HANDOFF_ENABLED = os.getenv("AI_AUTO_HANDOFF_ENABLED", "false").lower() == "true"
MANUAL_WHATSAPP_PAUSE_ENABLED = os.getenv("MANUAL_WHATSAPP_PAUSE_ENABLED", "true").lower() == "true"
